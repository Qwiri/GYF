<script lang="ts">
    ...
    import { ws, submissions } from "../../store";
    ...
    {#each $submissions as submission, i}
        <div class="image">
            {#if i === gifVoted}
                ...
                >
                    <path
                        d="M0.333008 12.2C0.33247 9.05906 1.59484 6.0498 3.8361 3.84929C6.07737 1.64878 9.10927 0.441829 12.2497 0.499995C15.9705 0.480235 19.521 2.05821 21.9997 4.83333C24.4784 2.05821 28.0288 0.480235 31.7497 0.499995C34.8901 0.441829 37.922 1.64878 40.1632 3.84929C42.4045 6.0498 43.6669 9.05906 43.6663 12.2C43.6663 23.8047 29.8452 32.5667 21.9997 39.5C14.1715 32.5082 0.333008 23.8133 0.333008 12.2Z"
                        fill="#219653"
                    />
                </svg>
            {/if}
...
<style lang="scss">
    #submissionsWrapper {
        ...
        #votedSvg {
            ...
            animation: plop-heart 0.5s cubic-bezier(0.075, 0.82, 0.165, 1) 0s 1
                alternate forwards;
        }
